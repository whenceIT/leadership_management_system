      ...
      <div className="grid grid-cols-12 gap-4 md:gap-6">
          ...
          <KPICard
            ...
            expandedContent={
              <div className="space-y-2 text-sm">
                <p className="text-gray-600 dark:text-gray-300">High Priority: 3</p>
                <p className="text-gray-600 dark:text-gray-300">Medium Priority: 5</p>
              </div>
            }
          />
        </div>
        ...
        <div className="col-span-12 md:col-span-6 lg:col-span-3">
          <KPICard
            ...
            expandedContent={
              <div className="space-y-2 text-sm">
                <p className="text-gray-600 dark:text-gray-300">Due Today: 3</p>
                <p className="text-gray-600 dark:text-gray-300">Due This Week: 5</p>
              </div>
            }
          />
        </div>
        ...
        <div className="col-span-12 md:col-span-6 lg:col-span-3">
          <KPICard
            ...
            expandedContent={
              <div className="space-y-2 text-sm">
                <p className="text-gray-600 dark:text-gray-300">This Week: 12</p>
                <p className="text-gray-600 dark:text-gray-300">This Month: 24</p>
              </div>
            }
          />
        </div>
        ...
        {alerts.length > 0 && (
          <div className="col-span-12">
            <CollapsibleCard title="Priority Items" defaultExpanded={true}>
        ...
        <div className="col-span-12 lg:col-span-6">
          <CollapsibleCard title="Workload Overview" defaultExpanded={true}>
            <div className="space-y-4">
