...
export default function ManagerAdministrationDashboard() {
  const jobInfo = {
  ...
  const jobPurpose = "The Manager Administration serves as the operational backbone of the institution, ensuring seamless day-to-day administrative functions. This role supports the institution's $100M valuation by enabling operational efficiency, maintaining regulatory compliance, and creating a productive work environment.";
  ...
  return (
    <DashboardBase
      title="Manager Administration Dashboard"
